...
// Fruityvice SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FruityviceSDK::test)
...
{
    private const SDK_CLASS = 'FruityviceSDK';
    ...
    private const SDK_BASE = 'fruityvice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../fruityvice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
