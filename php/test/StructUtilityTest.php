...
// Fruityvice SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FruityviceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FruityviceOmni::structfix($now, Struct::undef()))
                        !== json_encode(FruityviceOmni::structfix($val, Struct::undef()))) {
