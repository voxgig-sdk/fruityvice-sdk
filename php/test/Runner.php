...
class FruityviceTestRunner
{
    ...
    {
        $live = self::getenv('FRUITYVICE_TEST_LIVE');
        $override = self::getenv('FRUITYVICE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FRUITYVICE_TEST_EXPLAIN');
...
class_alias('FruityviceTestRunner', 'Runner');
class_alias('FruityviceHelpers', 'Helpers');
