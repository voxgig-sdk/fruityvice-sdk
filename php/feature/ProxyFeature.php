...
class FruityviceProxyFeature extends FruityviceBaseFeature
{
    ...
    public function init(FruityviceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FruityviceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
