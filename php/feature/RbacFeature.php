...
class FruityviceRbacFeature extends FruityviceBaseFeature
{
    ...
    private function _required(FruityviceContext $ctx): ?string
    {
    ...
    private function _reject(FruityviceContext $ctx, string $required): void
    {
    ...
    private function _track(FruityviceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
