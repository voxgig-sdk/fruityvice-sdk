...
// Fruityvice SDK clienttrack feature
...
class FruityviceClienttrackFeature extends FruityviceBaseFeature
{
    ...
    public function PostConstruct(FruityviceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Fruityvice-SDK';
