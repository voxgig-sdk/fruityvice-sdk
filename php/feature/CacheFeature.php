...
class FruityviceCacheFeature extends FruityviceBaseFeature
{
    ...
    private function _through(FruityviceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
