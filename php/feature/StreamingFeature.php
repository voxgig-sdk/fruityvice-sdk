...
// Fruityvice SDK streaming feature
...
class FruityviceStreamingFeature extends FruityviceBaseFeature
{
    ...
    private function _iterate(FruityviceResult $result): \Generator
    {
    ...
    private function _streamable(FruityviceContext $ctx): bool
    {
