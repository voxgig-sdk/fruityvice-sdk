...
// Fruityvice SDK timeout feature
...
class FruityviceTimeoutFeature extends FruityviceBaseFeature
{
    ...
    private function _with_timeout(FruityviceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FruityviceContext $_ctx, float $ms): void
    {
        $client = $this->client;
