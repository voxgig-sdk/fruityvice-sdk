...
class FruityviceNetsimFeature extends FruityviceBaseFeature
{
    ...
    private function _simulate(FruityviceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FruityviceContext $ctx, array $applied): void
    {
        $client = $this->client;
