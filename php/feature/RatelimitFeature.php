...
// Fruityvice SDK ratelimit feature
...
class FruityviceRatelimitFeature extends FruityviceBaseFeature
{
    ...
    private function _acquire(FruityviceContext $ctx): void
    {
    ...
    private function _track(FruityviceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
