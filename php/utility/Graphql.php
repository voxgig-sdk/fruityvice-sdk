...
// Fruityvice SDK utility: graphql
//
...
class FruityviceGraphql
{
    ...
    // equivalent.
    public static function body(FruityviceContext $ctx): mixed
    {
    ...
    public static function errors(FruityviceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
