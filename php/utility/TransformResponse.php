...
// Fruityvice SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FruityviceTransformResponse
{
    public static function call(FruityviceContext $ctx): mixed
    {
        ...
        $transform = FruityviceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
