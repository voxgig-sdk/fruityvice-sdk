...
// Fruityvice SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FruityviceMakeRequest
{
    public static function call(FruityviceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FruityviceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FruityviceResponse($fetched);
        } else {
