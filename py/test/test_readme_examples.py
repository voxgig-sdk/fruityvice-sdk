# Fruityvice SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FruityviceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FruityviceSDK(...) and FruityviceSDK.test(...) become
#      FruityviceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fruityvice_sdk"
_SDK_CLASS = "FruityviceSDK"
