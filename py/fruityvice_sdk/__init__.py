...
from fruityvice_sdk.utility import register

# Load features
from fruityvice_sdk.feature.base_feature import FruityviceBaseFeature
from fruityvice_sdk.features import _has_feature, _make_feature
...
class FruityviceSDK:
    ...
    def get_utility(self):
        return FruityviceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FruityviceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Fruit(self, data=None) -> "FruitEntity":
        ...
        from fruityvice_sdk.entity.fruit_entity import FruitEntity
