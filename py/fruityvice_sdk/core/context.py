...
from fruityvice_sdk.core.helpers import get_ctx_prop, to_map
...
class FruityviceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FruityviceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FruityviceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FruityviceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FruityviceError(code, msg, self)
