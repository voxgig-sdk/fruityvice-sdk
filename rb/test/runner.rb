...
module FruityviceTestRunner
  ...
  def self.env_override(m)
    live = getenv("FRUITYVICE_TEST_LIVE")
    override = getenv("FRUITYVICE_TEST_OVERRIDE")
    ...
    explain = getenv("FRUITYVICE_TEST_EXPLAIN")
    m["FRUITYVICE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = FruityviceTestRunner
Helpers = FruityviceHelpers
Vs = VoxgigStruct
