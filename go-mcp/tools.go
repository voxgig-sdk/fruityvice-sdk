...
type Args struct {
	Entity string         `json:"entity" jsonschema:"fruit"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FruityviceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fruityvice_list",
		Description: "List records from Fruityvice. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fruityvice_load",
		Description: "Load a single record from Fruityvice. " +
...
func runOp(client *sdk.FruityviceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FruityviceSDK, name string) (sdk.FruityviceEntity, error) {
