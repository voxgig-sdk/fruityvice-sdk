// Command Fruityvice-mcp is an MCP server exposing the Fruityvice
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Fruityvice_list  — list records of an entity
//	Fruityvice_load  — load a single record of an entity
//
