...
{
    private static function utility(): FruityviceUtility
    {
        return new FruityviceUtility();
    }
    ...
    private static function ctx(array $over = []): FruityviceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FruityviceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FruityviceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FruityviceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FruityviceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FruityviceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FruityviceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FruityviceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FruityviceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FruityviceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FruityviceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FruityviceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FruityviceResponse([]),
            'result' => new FruityviceResult([]),
        ]);
        [, $err] = FruityviceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FruityviceSpec([]),
            'response' => null,
            'result' => new FruityviceResult([]),
        ]);
        [, $err] = FruityviceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FruityviceSpec(['step' => 's']),
            'response' => new FruityviceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FruityviceResult([]),
        ]);
        [, $err] = FruityviceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FruityviceSpec(['step' => 's']),
            'response' => new FruityviceResponse(self::resp(200, ['v' => 1])),
            'result' => new FruityviceResult([]),
        ]);
        [, $err] = FruityviceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FruityviceSpec(['step' => 's']),
            'response' => new FruityviceResponse(self::resp(200, ['v' => 2])),
            'result' => new FruityviceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FruityviceMakeResponse::call($ctx);
    ...
    {
        $preset = new FruityviceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FruityviceSpec([]),
            'response' => new FruityviceResponse([]),
            'result' => new FruityviceResult([]),
        ...
        [$got, $err] = FruityviceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FruityviceResult([])]);
        [, $err] = FruityviceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FruityviceSpec([]), 'result' => null]);
        [, $err] = FruityviceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FruityviceSpec(['step' => 's']),
            'result' => new FruityviceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FruityviceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FruityviceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FruityviceSpec(['step' => 's']),
            'result' => new FruityviceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FruityviceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FruityviceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FruityviceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FruityviceSpec([]),
            'result' => new FruityviceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FruityviceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FruityviceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FruityviceError('boom', 'boom');
        $utility->fetcher = function (FruityviceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FruityviceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FruityviceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FruityviceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FruityviceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FruityviceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FruityviceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FruityviceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FruityviceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FruityviceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FruityviceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FruityviceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FruityviceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FruityviceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FruityviceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FruityviceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FruityviceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FruityviceResult(['ok' => false])]);
        $this->expectException(FruityviceError::class);
        FruityviceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FruityviceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FruityviceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FruityviceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FruityviceBaseFeature();
        $b = new FruityviceBaseFeature();
        FruityviceFeatureAdd::call($ctx, $a);
        FruityviceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FruityviceBaseFeature
    {
        $f = new FruityviceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FruityviceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FruityviceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FruityviceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FruityvicePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FruityvicePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FruityviceResponse(['headers' => null]),
            'result' => new FruityviceResult([]),
        ]);
        FruityviceResultHeaders::call($ctx);
