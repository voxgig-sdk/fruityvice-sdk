...
// Fruityvice SDK idempotency feature
...
class FruityviceIdempotencyFeature extends FruityviceBaseFeature
{
    ...
    private function _mutating(FruityviceContext $ctx): bool
    {
