...
// Fruityvice SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FruityviceTestFeature extends FruityviceBaseFeature
{
    ...
    public function init(FruityviceContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FruityviceContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FruityviceParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FruityviceContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FruityviceContext $ctx, $op, $args): array
    {
