...
// Fruityvice SDK utility: fetcher

class FruityviceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FruityviceSDK/1.0)';
    ...
    public static function call(FruityviceContext $ctx, string $fullurl, array $fetchdef): array
    {
