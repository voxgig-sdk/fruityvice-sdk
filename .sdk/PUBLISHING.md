...
|---|---|---|
| `ts/` | @voxgig-sdk/fruityvice-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fruityvice-sdk \
      --repository voxgig-sdk/fruityvice-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fruityvice-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fruityvice-sdk --id=<id>` removes it.
