...
function envOverride(m) {
    if ('TRUE' === process.env.FRUITYVICE_TEST_LIVE ||
        'TRUE' === process.env.FRUITYVICE_TEST_OVERRIDE) {
    ...
    m.FRUITYVICE_TEST_EXPLAIN = process.env.FRUITYVICE_TEST_EXPLAIN || m.FRUITYVICE_TEST_EXPLAIN;
    return m;
}
