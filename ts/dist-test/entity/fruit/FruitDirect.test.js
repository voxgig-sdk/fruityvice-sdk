...
(0, node_test_1.describe)('FruitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FruityviceSDK({
...
function liveScenariosActive() { return false && process.env.FRUITYVICE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FruityviceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FRUITYVICE_TEST_FRUIT_ENTID'];
    ...
    const client = new __1.FruityviceSDK({
        base: 'http://localhost:8080',
