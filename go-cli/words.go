...
func registerSDKWords(r *eng.Registry, client *sdk.FruityviceSDK) {
...
func runOp(client *sdk.FruityviceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
