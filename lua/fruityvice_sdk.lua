...
local FruityviceSDK = {}
FruityviceSDK.__index = FruityviceSDK
...
FruityviceSDK._make_feature = _make_feature


function FruityviceSDK.new(options)
  local self = setmetatable({}, FruityviceSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FruityviceSDK:options_map()
...
function FruityviceSDK:get_utility()
  return Utility.copy(self._utility)
end


function FruityviceSDK:get_root_ctx()
  return self._rootctx
end


function FruityviceSDK:prepare(fetchargs)
...
function FruityviceSDK:direct(fetchargs)
...
-- by passing it.
function FruityviceSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FruityviceSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "FruityviceSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function FruityviceSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FruityviceSDK.new(sdkopts)
  sdk.mode = "test"
