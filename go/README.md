...
## Install
```bash
go get github.com/voxgig-sdk/fruityvice-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/fruityvice-sdk=../path/to/github.com/voxgig-sdk/fruityvice-sdk
```
...
```
github.com/voxgig-sdk/fruityvice-sdk/
...
The root package (`github.com/voxgig-sdk/fruityvice-sdk`) re-exports everything needed
