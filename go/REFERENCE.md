# Fruityvice Golang SDK Reference

Complete API reference for the Fruityvice Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FruityviceSDK`
...
#### `Fruit(data map[string]any) FruityviceEntity`
