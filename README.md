...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/fruityvice` | `npm install @voxgig-sdk/fruityvice` |
| Python | `voxgig-sdk-fruityvice` | `pip install voxgig-sdk-fruityvice` |
| PHP | `voxgig-sdk/fruityvice` | `composer require voxgig-sdk/fruityvice` |
| Golang | `github.com/voxgig-sdk/fruityvice-sdk/go` | `go get github.com/voxgig-sdk/fruityvice-sdk/go` |
| Ruby | `voxgig-sdk-fruityvice` | `gem install voxgig-sdk-fruityvice` |
| Lua | `voxgig-sdk-fruityvice` | `luarocks install voxgig-sdk-fruityvice` |
